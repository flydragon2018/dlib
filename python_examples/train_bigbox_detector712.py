...
training_xml_path = os.path.join(faces_folder, "faceneck_anno_train712.xml")
testing_xml_path = os.path.join(faces_folder, "faceneck_anno_test712.xml")
...
# dlib.
dlib.train_simple_object_detector(training_xml_path, "faceneck_detector.svm", options)
...
print("Training accuracy: {}".format(
    dlib.test_simple_object_detector(training_xml_path, "faceneck_detector.svm")))
# However, to get an idea if it really worked without overfitting we need to
# run it on images it wasn't trained on.  The next line does this.  Happily, we
# see that the object detector works perfectly on the testing images.
print("Testing accuracy: {}".format(
    dlib.test_simple_object_detector(testing_xml_path, "faceneck_detector.svm")))
...
detector = dlib.simple_object_detector("faceneck_detector.svm")
...
detector2 = dlib.fhog_object_detector("faceneck_detector.svm") 
