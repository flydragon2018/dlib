...
dlib.train_shape_predictor(training_xml_path, "my_predictor.dat", options)

# Now that we have a model we can test it.  dlib.test_shape_predictor()
# measures the average distance between a face landmark output by the
# shape_predictor and where it should be according to the truth data.
print("\nTraining accuracy: {}".format(
    dlib.test_shape_predictor(training_xml_path, "my_predictor.dat")))
...
print("Testing accuracy: {}".format(
    dlib.test_shape_predictor(testing_xml_path, "my_predictor.dat")))
...
for f in glob.glob(os.path.join(faces_folder, "*.jpg")):
    ...
    for k, d in enumerate(dets):
        ...
        print("Part 0: {}, Part 1: {} ...Part 100: {}".format(shape.part(0),shape.part(1),shape.part(101)))
